...
public class ApprovedEventsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_approved_events, container, false);
    }
                        ...
                        if (value != null) {
                            ...
                            adapter = new RecyclerView.Adapter() {
                                ...
                                public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                                    ...
                                    View eventView = inflater.inflate(R.layout.approved_events_single_view, parent, false);
                                    return new AVH(eventView);
                                }
                            ...
                            RecyclerView recyclerView = view.findViewById(R.id.recyclerViewApprovedEventsView);
